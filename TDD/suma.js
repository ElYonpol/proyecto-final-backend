...
console.log("La función debe devolver 0 si no paso parámetros -> () --> 0");
...
if (resultTest2 === 0) {
	...
	console.log(`Test 2 fallado, se recibió ${resultTest2} pero se esperaba 0.`);
}
...
if (resultTest3 === 5) {
	...
	console.log(`Test 3 fallado, se recibió ${resultTest3} pero se esperaba 5.`);
}

// Debe poder sumar cualquier cantidad de números
console.log("Debe poder sumar cualquier cantidad de números");
...
if (resultTest4 === 15) {
	...
	console.log(`Test 4 fallado, se recibió ${resultTest4} pero se esperaba 15.`);
}
